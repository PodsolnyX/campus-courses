                        ...
                        props.data.status === "Accepted" ?
                            <div className={"row text-md-end"}>
                                <div className={"col-12 mb-2"} onClick={props.openMarkModal} style={{cursor: "pointer"}}>
                                    ...
                                    <span className={`badge ms-1 bg-${CONST.RESULT_STATUS_COLOR[props.data.midtermResult]}`} >
                                        {CONST.RESULT_STATUS[props.data.midtermResult]}
                                    </span>
                                </div>
                                <div className={"col-12"} onClick={props.openMarkModal} style={{cursor: "pointer"}}>
                                    Финальная аттестация -
                                    <span className={`badge ms-1 bg-${CONST.RESULT_STATUS_COLOR[props.data.finalResult]}`}>
